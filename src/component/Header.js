...
import logo from '../assets/supermarket_logo.png'
          ...
          <div className="flex items-center gap-4 md:gap-7">
            ...
            <div className='text-2xl text-slate-600' onClick={handleShowMenu}>
              ...
              <div className='absolute right-2 bg-white py-2 px-2 shadow drop-shadow-md flex flex-col'>
                <Link to={"newproduct"} className='whitespace-nowrap text-xl cursor-pointer'>New product</Link>
                <Link to={"login"} className='whitespace-nowrap text-xl cursor-pointer'>Login</Link>
              </div>
              )}
